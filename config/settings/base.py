...
"""
CREATE DATABASE steamboat;
CREATE USER steamboat WITH PASSWORD '<PASSWORD>';
...
MIGRATION_MODULES = {"sites": "steamboat.contrib.sites.migrations"}
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            ...
            "context_processors": [
                ...
                "steamboat.users.context_processors.allauth_settings",
            ],
        },
    },
]
...
ADMINS = [("""Robert A. Petit III""", "robbie.petit@gmail.com")]
...
# https://docs.allauth.org/en/latest/account/configuration.html
ACCOUNT_ADAPTER = "steamboat.users.adapters.AccountAdapter"
# https://docs.allauth.org/en/latest/account/forms.html
ACCOUNT_FORMS = {"signup": "steamboat.users.forms.UserSignupForm"}
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_ADAPTER = "steamboat.users.adapters.SocialAccountAdapter"
# https://docs.allauth.org/en/latest/socialaccount/configuration.html
SOCIALACCOUNT_FORMS = {"signup": "steamboat.users.forms.UserSocialSignupForm"}
...
SPECTACULAR_SETTINGS = {
    "TITLE": "steamboat API",
    "DESCRIPTION": "Documentation of API endpoints of steamboat",
    "VERSION": "1.0.0",
